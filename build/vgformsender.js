    ...
    if ($alert) {
      ...
      if ($text) {
        if (typeof response === 'string') {
          ...
          let errors = (0,_util_functions__WEBPACK_IMPORTED_MODULE_1__.normalizeData)(response.errors);
